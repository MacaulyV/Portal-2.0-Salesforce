    ...
    <article className={styles.SectionCRM}>
      ...
      <div className={styles.Blocos}>
        ...
        <div className={styles.Bloco1}>
          ...
          {/* Imagem do Bloco 1 */}
          <h3 className={styles.Subtitulo}>Pequenas Empresas</h3>
        ...
        <div className={styles.Bloco2}>
          ...
          {/* Imagem do Bloco 2 */}
          <h3 className={styles.Subtitulo2}>Venda</h3>
          <p className={styles.Texto}>
        ...
        <div className={styles.Bloco3}>
          ...
          {/* Imagem do Bloco 3 */}
          <h3 className={styles.Subtitulo3}>Serviço</h3>
          <p className={styles.Texto}>
        ...
        <div className={styles.Bloco4}>
          ...
          {/* Imagem do Bloco 4 */}
          <h3 className={styles.Subtitulo}>Ver todos os produtos</h3>
          <p className={styles.Texto}>
            {" "}
